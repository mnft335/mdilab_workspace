function result = solve_proposal(shared_config, specific_config)
    ...
    problem_config.L = @(z) {shared_config.Phi(z{1}), ...
                             shared_config.G.weights .* shared_config.G.Diff * z{1} - shared_config.G.weights .* z{2}, ...
    ...
    algorithm_config.Gamma_y = {1, ...
                                1 / (sqrt(max(eig(shared_config.G.Diff.' * diag(shared_config.G.weights) * diag(shared_config.G.weights) * shared_config.G.Diff))) + max(shared_config.G.weights)), ...
