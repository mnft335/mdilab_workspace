...
param.corrupted_graph.forward_weight_corruption.idx_to_corrupt.corruption_ratio = 0.1:0.1:1.0;
...
param.corrupted_graph.forward_weight_corruption.noise.std_dev = 0.1:0.1:1.0;
...
param.true_signal.smooth_sampling_coefficients.std_dev = 0.1:0.1:1.0;
param.true_signal.smooth_sampling_coefficients.sampling_ratio = 0.1:0.1:0.5;
param.true_signal.smooth_sampling_coefficients.random_seed = 1:10;

param.observation_model.type = "inpainting";
param.observation_model.masking_ratio = 0.1:0.1:0.5;
param.observation_model.random_seed_signal_mask = 1:10;
param.observation_model.std_dev = 0.1:0.1:1.0;
param.observation_model.random_seed_signal_noise = 1:10;
