function weights_forward = generate_truncated_normal_weights(stream, num_forward_edges, sigma)
    ...
    weights_forward = icdf(truncated_normal_distribution, rand(stream, num_forward_edges, 1));
