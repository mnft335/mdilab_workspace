...
path_image_registry = "projects\research\gsp\graph_signal_restoration\resources\data\images\qualitative_experiment\restoration_residual";
...
for i = 1:length(field_names)
    ...
    graph_plot = plot_restoration_residual_for_paper(result);
