...
load("C:\Users\Owner\Downloads\research\mdilab\programs\projects\research\gsp\graph_signal_restoration\results\test_grid_all1.mat");
...
result_of_interest = result{sub2ind(size(grid_master_seed), idx_master_seed, idx_ratio_masked_nodes, idx_standard_deviation_signal_noise)};
