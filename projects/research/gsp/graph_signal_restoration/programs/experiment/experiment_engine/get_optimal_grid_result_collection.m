function optimal_grid_result_collection = get_optimal_grid_result_collection(grid_param_skeleton, num_points, mode_grid_run, arg)
    ...
    optimal_grid_result_collection_proposal = get_optimal_grid_result_collection_proposal(grid_param_skeleton, num_points, mode_grid_run, arg);
