...
%     % plot(0.1:0.1:1.0, ones(10, 1) .* glr_accuracy(i, 1), "black");
%     % plot(0.1:0.1:1.0, ones(10, 1) .* gtv_accuracy(i, 1), "blue");
%     % plot(0.1:0.1:1.0, ones(10, 1) .* proposal_accuracy(i, 1), "red");
