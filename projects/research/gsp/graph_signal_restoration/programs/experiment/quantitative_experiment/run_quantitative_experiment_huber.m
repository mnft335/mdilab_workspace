...
grid_param.corrupted_graph.forward_weight_corruption.idx_to_corrupt.corruption_ratio = 0.2;
...
grid_param.true_signal.smooth_sampling_coefficients.random_seed = 1;

grid_param.observation_model.type = "inpainting_without_noise";
grid_param.observation_model.masking_ratio = 0.1;
grid_param.observation_model.random_seed_signal_mask = 1:20;
...
grid_param.optimization.type = "proposal_6";
