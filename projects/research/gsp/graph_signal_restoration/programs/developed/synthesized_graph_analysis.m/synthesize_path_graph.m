function synthesize_path_graph()
    ...
    save_file(path_graph_uniform, path_synthesized_graph_collection.path_graph_uniform);
    ...
    save_file(path_graph_1_spike, path_synthesized_graph_collection.path_graph_1_spike);
    ...
    path_graph_1_drop = generate_new_graph(path_graph_uniform.W, generate_new_forward_weights);
    save_file(path_graph_1_drop, path_synthesized_graph_collection.path_graph_1_drop);
    ...
    save_file(path_graph_11_spikes, path_synthesized_graph_collection.path_graph_11_spikes);
    ...
    save_file(path_graph_11_drops, path_synthesized_graph_collection.path_graph_11_drops);
