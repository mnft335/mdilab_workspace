...
param.corrupted_graph.forward_weight_corruption.idx_to_corrupt.corruption_ratio = 0.2;
...
param.corrupted_graph.forward_weight_corruption.noise.std_dev = 0.1;
...
param.observation_model.masking_ratio = 0.1;
param.observation_model.random_seed_signal_mask = 1;
param.observation_model.std_dev = 0.1;
