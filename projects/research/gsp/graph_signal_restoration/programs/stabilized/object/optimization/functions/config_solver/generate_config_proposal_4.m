function config_proposal_4 = generate_config_proposal_4(graph, true_signal, observation_model, coefficient_l1)
    ...
    config_proposal_4.step_size_dual_variable_l2 = 1 / (1 + norm_upper_bound_weighted_incidence_operator);
    ...
    config_proposal_4.initial_dual_variable_l2 = zeros(graph.Ne, 1);
