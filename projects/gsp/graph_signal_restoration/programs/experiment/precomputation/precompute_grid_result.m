...
grid_param_skeleton.corrupted_graph.forward_weight_corruption.idx_to_corrupt.random_seed = 1:20;
...
range_hyperparameter = linspace(0, 1, 100 + 2);
grid_param_skeleton.optimization.coefficient_l1 = range_hyperparameter(2:end-1);

% Create a list of methods
list_methods = ["glr", "gtv", "proposal_2", "proposal_3", "proposal_4", "proposal_1"];
