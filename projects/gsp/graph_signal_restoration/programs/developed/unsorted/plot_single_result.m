...
% param.true_graph.true_forward_weights.std_dev = 1;
% param.true_graph.true_forward_weights.random_seed = 1;

% param.corrupted_graph.type = "no_corruption";
...
param.corrupted_graph.forward_weight_corruption.idx_to_corrupt.corruption_ratio = 0.3;
...
param.true_signal.smooth_sampling_coefficients.sampling_ratio = 0.1;
...
% param.observation_model.std_dev = 0.05;
...
param.optimization.coefficient_l1 = range_hyperparameter(10);

result = get_result(param, []);
% plot_resultant_graph_signals(result, "horizontal");