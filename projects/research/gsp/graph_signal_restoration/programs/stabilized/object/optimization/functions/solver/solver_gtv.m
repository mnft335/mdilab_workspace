function result = solver_gtv(config_gtv)
    ...
    formulation_config.L = @(z) {config_gtv.observation_operator(z{1}), ...
                                 config_gtv.weighted_incidence_operator(z{1})};
    formulation_config.Lt = @(z) {config_gtv.observation_operator_adjoint(z{1}) + config_gtv.weighted_incidence_operator_adjoint(z{2})};
