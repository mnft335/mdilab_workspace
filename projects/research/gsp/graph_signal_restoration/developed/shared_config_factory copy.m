function shared_config = shared_config_factory(concrete_config)
    ...
    shared_config.b = shared_config.Phi(shared_config.true_signal + concrete_config.signal_noise_sigma * randn(size(shared_config.true_signal)));

    % Regularization parameters
    shared_config.lower = 0;
    shared_config.upper = 1;
    shared_config.epsilon = 0.9 * sqrt((1 - concrete_config.masking_rate) * shared_config.G.N) * concrete_config.signal_noise_sigma;
