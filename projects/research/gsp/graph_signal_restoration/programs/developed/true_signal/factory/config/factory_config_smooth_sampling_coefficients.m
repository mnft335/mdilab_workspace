function config_smooth_sampling_coefficients = factory_config_smooth_sampling_coefficients(param, arg)
    ...
    switch param.type
        ...
        case "gaussian"
            ...
            % Create a function handle that generates non-zero coefficients
            random_stream = create_random_stream(param.random_seed, "generate_smooth_sampling_coefficients:gaussian");
            ...
            config_smooth_sampling_coefficients.generate_smooth_sampling_coefficients = @(ascending_eigenvectors) apply_partial_elements(zeros(size(ascending_eigenvectors, 2), 1), 1:int64(size(ascending_eigenvectors, 2) * param.sampling_ratio), generate_nonzero_coefficients);
