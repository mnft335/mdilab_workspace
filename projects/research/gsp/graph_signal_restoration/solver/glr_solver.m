function result = glr_solver(config_glr)
    ...
    formulation_config.L = @(z) {config_glr.observation_operator(z{1}), ...
                                 config_glr.root_laplacian_operator(z{1})};
    formulation_config.Lt = @(z) {config_glr.observation_operator_adjoint(z{1}) + config_glr.root_laplacian_operator_adjoint(z{2})};
