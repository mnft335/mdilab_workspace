function result = solver_glr(config_glr)
    ...
    prox_conj_l2_squared = prox.conjugate(@(z, gamma) prox.l2_squared(z, gamma, config_glr.coefficient_l2_squared));
