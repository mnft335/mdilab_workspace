function config_forward_weight_corruption = factory_config_forward_weight_corruption(param, arg)
    ...
    switch param.type
        ...
        case "additive"
            ...
            % Create a function handle that adds noise to the forward weights on partial indices
            ...
            config_forward_weight_corruption.generate_corrupted_forward_weights = @(true_forward_weights) apply_partial_elements(true_forward_weights, generate_idx_forward_weights_to_corrupt(true_forward_weights), corrupt_forward_weights);
        ...
        % Corrupt by flipping binary weights
        case "binary_flip"
