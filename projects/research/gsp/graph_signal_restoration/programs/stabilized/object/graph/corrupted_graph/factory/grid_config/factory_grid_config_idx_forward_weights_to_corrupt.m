function grid_config_forward_weights_to_corrupt = factory_grid_config_idx_forward_weights_to_corrupt(param, arg)
    ...
    switch param.type
        ...
        case "all"
            ...
            % Create a cell of parameter names
            grid_config_forward_weights_to_corrupt.parameter_name = {};

            % Create a cell of parameter ranges
            grid_config_forward_weights_to_corrupt.parameter_range = {};
        ...
        case "specify"
            ...
            % Create a cell of parameter names
            grid_config_forward_weights_to_corrupt.parameter_name = {{"cut_name"}};

            % Create a cell of parameter ranges
            grid_config_forward_weights_to_corrupt.parameter_range = {param.cut_name};
