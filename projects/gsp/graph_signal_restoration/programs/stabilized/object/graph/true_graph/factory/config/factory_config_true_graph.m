...
switch param.type
    ...
    case "generate"
        ...
        adjacency_matrix = config_adjacency_matrix.generate_adjacency_matrix();
        coordinates = config_adjacency_matrix.coordinates;
        ...
        config_true_graph.generate_true_graph = @() generate_new_graph(double(adjacency_matrix), generate_true_forward_weights, coordinates);
