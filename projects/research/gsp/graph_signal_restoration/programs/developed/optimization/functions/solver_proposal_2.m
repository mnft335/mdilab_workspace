function result = solver_proposal_2(config_proposal_2)
    ...
    prox_conj_l2_ball = prox.conjugate(@(z, gamma) prox.l2_ball(z, config_proposal_2.observed_signal, config_proposal_2.radius_l2_ball));
    ...
    formulation_config.grad_f = @(z) {zeros(size(z{1})), ...
                                      zeros(size(z{2}))};
    formulation_config.prox_g = @(z, gamma) {prox.box(z{1}, config_proposal_2.signal_lower_bound, config_proposal_2.signal_upper_bound), ...
    ...
    pds_config.gamma_y = {config_proposal_2.step_size_dual_variable_l2_ball, ...
                          config_proposal_2.step_size_dual_variable_l1, ...
    ...
    pds_config.y_init = {config_proposal_2.initial_dual_variable_l2_ball, ...
                         config_proposal_2.initial_dual_variable_l1, ...
