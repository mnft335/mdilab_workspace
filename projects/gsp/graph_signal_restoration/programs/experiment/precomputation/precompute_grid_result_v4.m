...
for j = 1:numel(shared_random_seed)
    ...
    grid_param_skeleton.corrupted_graph.forward_weight_corruption.idx_to_corrupt.corruption_ratio = 0.1:0.1:0.3;
    ...
    grid_param_skeleton.observation_model.random_seed_signal_mask = shared_random_seed(j);
    grid_param_skeleton.observation_model.std_dev = 0.05;
    grid_param_skeleton.observation_model.random_seed_signal_noise = shared_random_seed(j);
