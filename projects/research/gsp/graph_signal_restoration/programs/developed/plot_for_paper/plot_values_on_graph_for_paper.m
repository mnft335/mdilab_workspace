function graph_plot = plot_values_on_graph_for_paper(graph_gsp_toolbox, config_node, config_edge)
    ...
    % % Set edge color
    % graph_plot.EdgeColor = "black";

    % % Set edge width
    % graph_plot.LineWidth = normalize_data(config_edge.values, [0.1, 1])
